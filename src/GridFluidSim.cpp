...
void GridFluidSim::_initialize(EX ex)
{
	...
	_gridState[_INDEX(2, 3)] = STATE::FLUID;
	_gridState[_INDEX(3, 3)] = STATE::FLUID;
	_gridState[_INDEX(4, 3)] = STATE::FLUID;
	_gridState[_INDEX(5, 3)] = STATE::FLUID;
	//_gridState[15] = STATE::FLUID;
}
